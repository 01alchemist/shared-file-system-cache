...
@global @unsafe export function __allocator_get_offset(): usize {
  return atomic.load<usize>(OFFSET_PTR);
}

@global @unsafe export function __allocator_set_offset(oldOffset: usize, newOffset: usize): usize {
